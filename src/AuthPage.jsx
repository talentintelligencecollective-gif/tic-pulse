...
export default function AuthPage({ onAuth }) {
  ...
  return (
    ...
    >
      <link
        href="https://fonts.googleapis.com/css2?family=Playfair+Display:wght@400;600;700;800&family=DM+Sans:opsz,wght@9..40,300;9..40,400;9..40,500;9..40,600;9..40,700;9..40,800&display=swap"
        rel="stylesheet"
      />
      ...
      <style>{`
        ...
        input:focus { border-color: rgba(0,229,160,0.4) !important; }
      `}</style>
      ...
      >
        ...
        <p style={{ fontSize: "10px", fontWeight: 700, color: "#555", letterSpacing: "2.5px", margin: 0 }}>
        ...
        <div>
          ...
          <button
            ...
            style={{
              ...
              transition: "all 0.2s",
              letterSpacing: "0.2px",
              opacity: (!email || !password || (mode === "signup" && !fullName)) ? 0.4 : 1,
            }}
          >
            {loading
              ? "Please wait..."
